...
/**
 * Creates a private, writable URI for [RecipeEditorTakePictureContract]. The editor copies this
 * source through its normal image-cache path after capture, so it remains available to an offline
 * draft even when the eventual Mealie upload cannot run.
 */
